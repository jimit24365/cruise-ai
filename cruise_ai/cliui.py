"""
cruise_ai.cliui — minimal ANSI styling for CLI output.
...
def guide() -> str:
    ...
    on = color_enabled()
    out = []
    title = "How cruise_ai works — the pipeline"
