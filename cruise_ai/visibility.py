"""
cruise_ai.visibility -- User-controlled visibility config.

Persistent config at ``~/.cruise_ai/data/visibility.json`` lets users
...
from cruise_ai.paths import visibility_config_path
