"""
cruise_ai.adapters.kiro -- Kiro CLI / Kiro IDE adapter.
...
from cruise_ai.scanner import safe_read_text
    ...
    **Generation 2 — Kiro IDE** (deep fidelity, no tool-call names):
    ...
    def __init__(
        ...
        *,
        ...
        # cruise_ai.scanner.KIRO_* propagates even to bare KiroAdapter().
