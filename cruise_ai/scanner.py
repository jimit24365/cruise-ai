#!/usr/bin/env python3
"""
cruise_ai Scanner — Multi-tool AI coding profile builder.
...
def log(msg: str) -> None:
    ...
    summaries); `-v/--verbose` or CRUISE_AI_VERBOSE=1 restores the
    per-repo detail.
    """
...
def scan_claude_code(project_filter: str | None = None) -> dict | None:
    ...
    Delegates to :class:`~cruise_ai.adapters.claude_code.ClaudeCodeAdapter`.
    """
...
def scan_cursor(project_filter: str | None = None) -> dict | None:
    ...
    Delegates to :class:`~cruise_ai.adapters.cursor.CursorAdapter`.
    """
    from cruise_ai.adapters.cursor import CursorAdapter
...
def scan_codex() -> dict | None:
    ...
    Delegates to :class:`~cruise_ai.adapters.codex.CodexAdapter`.
...
def list_tools() -> None:
    ...
    print("cruise_ai Scanner — Detected AI Tools")
    print("=" * 50)
...
if __name__ == "__main__":
    from cruise_ai.build_profile import main as _cli_main
