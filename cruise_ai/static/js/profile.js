...
function render(P){
  ...
  if(sdEl){
    ...
    var toolLabels={claude_code:'Claude Code',cursor:'Cursor',codex:'Codex CLI',kiro:'Kiro',claude_desktop:'Claude Desktop',aider:'Aider',cline:'Cline','continue':'Continue.dev',copilot_chat:'Copilot Chat',windsurf:'Windsurf',zed_ai:'Zed AI',jetbrains_ai:'JetBrains AI',cody:'Cody',antigravity:'Antigravity',opencode:'OpenCode'};
...
function renderStrengthHighlight(P){
  ...
  var hint=((P.enrichment||{}).source||'heuristic')==='heuristic'
    ?'<div style="font-family:var(--mono);font-size:10.5px;color:var(--muted);margin-top:8px">Run <code>cruise_ai enrich</code> for richer strengths and narrative.</div>':'';
...
// A clone without pip-install has no `cruise_ai` on PATH; the hub
