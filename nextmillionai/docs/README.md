# `nextmillionai/docs/` — engine contract docs
...
| [`methodology/DERIVATIONS.md`](./methodology/DERIVATIONS.md) | `@generated` per-metric reference (logic + reasoning + provenance + citations) from the methodology registry. Never edit by hand — edit `nextmillionai/methodology_spec.py` and regenerate. |
