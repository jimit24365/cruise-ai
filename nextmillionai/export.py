"""
nextmillionai.export -- Static, self-hostable artifact.

`nextmillionai export` renders the profile + report into a directory the
...
from nextmillionai.paths import STATIC_DIR, profile_path
