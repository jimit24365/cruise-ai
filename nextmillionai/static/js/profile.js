...
function render(P){
  ...
  if(sdEl){
    ...
    var toolLabels={claude_code:'Claude Code',cursor:'Cursor',codex:'Codex CLI',claude_desktop:'Claude Desktop',aider:'Aider',cline:'Cline','continue':'Continue.dev',copilot_chat:'Copilot Chat',windsurf:'Windsurf',zed_ai:'Zed AI',jetbrains_ai:'JetBrains AI',cody:'Cody'};
